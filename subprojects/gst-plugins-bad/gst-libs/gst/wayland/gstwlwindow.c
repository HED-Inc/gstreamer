    ...
    GstVideoColorimetry * colorimetry)
{
  ...
  switch (colorimetry->transfer) {
    case GST_VIDEO_TRANSFER_SRGB:
      wl_transfer_function = XX_COLOR_MANAGER_V2_TRANSFER_FUNCTION_SRGB;
      break;
    case GST_VIDEO_TRANSFER_BT601:
    case GST_VIDEO_TRANSFER_BT709:
    case GST_VIDEO_TRANSFER_BT2020_10:
      wl_transfer_function = XX_COLOR_MANAGER_V2_TRANSFER_FUNCTION_BT709;
      break;
    case GST_VIDEO_TRANSFER_SMPTE2084:
      wl_transfer_function = XX_COLOR_MANAGER_V2_TRANSFER_FUNCTION_ST2084_PQ;
      break;
    case GST_VIDEO_TRANSFER_ARIB_STD_B67:
      wl_transfer_function = XX_COLOR_MANAGER_V2_TRANSFER_FUNCTION_HLG;
      break;
    default:
      g_assert_not_reached ();
  }
  ...
  switch (colorimetry->primaries) {
    case GST_VIDEO_COLOR_PRIMARIES_BT709:
      wl_primaries = XX_COLOR_MANAGER_V2_PRIMARIES_SRGB;
      break;
    case GST_VIDEO_COLOR_PRIMARIES_SMPTE170M:
      wl_primaries = XX_COLOR_MANAGER_V2_PRIMARIES_NTSC;
      break;
    case GST_VIDEO_COLOR_PRIMARIES_BT2020:
      wl_primaries = XX_COLOR_MANAGER_V2_PRIMARIES_BT2020;
      break;
    default:
      g_assert_not_reached ();
  }
